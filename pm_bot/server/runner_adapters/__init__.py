...
from pm_bot.server.runner_adapters.manual import ManualRunnerAdapter
from pm_bot.server.runner_adapters.provider_stub import ProviderStubRunnerAdapter


def registered_runner_adapters(enable_provider_stub: bool = False) -> dict[str, Any]:
...
def build_runner_adapters_from_env(env: dict[str, str] | None = None) -> dict[str, Any]:
    ...
    return registered_runner_adapters(enable_provider_stub=enabled)
