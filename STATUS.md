...
- Stabilized UI integration coverage for Plan Intake to Inbox approval/apply flow by enforcing per-test DOM cleanup in `ui/src/App.test.tsx`, and updated the E2E evidence runbook metadata contract in `docs/runbooks/plan-intake-inbox-e2e.md` to satisfy docs hygiene gates.
