...
- Added UI integration coverage for full Plan Intake to Inbox approval/apply flow (`ui/src/App.test.tsx`) and a reproducible evidence runbook (`docs/runbooks/plan-intake-inbox-e2e.md`), then cross-linked v6 roadmap closure notes.
